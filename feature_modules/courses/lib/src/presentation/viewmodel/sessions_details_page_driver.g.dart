...
part of 'sessions_details_page_driver.dart';
...
class _$TestSessionsDetailsPageDriver extends TestDriver
    implements SessionsDetailsPageDriver {
  @override
  List<SessionModel> sessions = [_testSession];
...
class $SessionsDetailsPageDriverProvider
    extends WidgetDriverProvider<SessionsDetailsPageDriver> {
  final List<SessionModel> _sessions;

  $SessionsDetailsPageDriverProvider({
    required List<SessionModel> sessions,
  }) : _sessions = sessions;

  @override
  SessionsDetailsPageDriver buildDriver() {
    return SessionsDetailsPageDriver(
      sessions: _sessions,
    );
  }

  @override
  SessionsDetailsPageDriver buildTestDriver() {
    return _$TestSessionsDetailsPageDriver();
  }

  @override
  void updateDriverProvidedProperties(SessionsDetailsPageDriver driver) {
    // In case you get a compiler error here, you have to implement _$DriverProvidedProperties in your driver.
    // Like this:
    //  class SessionsDetailsPageDriver extends WidgetDriver implements _$DriverProvidedProperties {
    //
    //    ...
    //
    //    @override
...
abstract class _$DriverProvidedProperties {
  ...
  void didUpdateProvidedProperties({
    required List<SessionModel> newSessions,
  });
}
