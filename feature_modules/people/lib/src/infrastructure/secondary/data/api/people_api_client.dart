...
class PeopleApiClient {
  ...
  Future<List<PeopleDto>> getPeople() async {
    ...
    return [
      const PeopleDto(id: '1', name: 'Alstermann, Max', title: 'Wis. Mitarbeiter'),
      const PeopleDto(id: '2', name: 'Alsterfrau, Erika', title: 'Lehrbeauftragte'),
      const PeopleDto(id: '3', name: 'Max Alsterfrau', title: 'Professor:in'),
