...
import 'people_suggestion_tile.dart';

class PeoplePageLoading extends StatelessWidget {
  const PeoplePageLoading({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const LmuSkeleton(child: IgnorePointer(child: PeopleSuggestionTile())),
