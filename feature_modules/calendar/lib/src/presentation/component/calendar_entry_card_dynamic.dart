...
class CalendarCardExperimental2 extends StatelessWidget {
  const CalendarCardExperimental2({
    super.key,
    required this.entry,
    this.fontSizeOverride,
    required this.onTap,
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GestureDetector(
          onTap: onTap,
          // 1. Add ClipRect HERE. This will clip everything inside the
          // container that tries to paint outside its rounded-corner bounds.
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: LmuSizes.size_2),
            child: ClipRRect(
              clipBehavior: Clip.antiAlias,
              // Use ClipRRect to respect the border radius of the container.
              borderRadius: BorderRadius.circular(8.0),
              child: Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                ...
                // The rest of your child content remains exactly the same.
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    /// Farbbalken über die ganze Höhe
