...
TasteProfilePreset _$TasteProfilePresetFromJson(Map<String, dynamic> json) => TasteProfilePreset(
...
Map<String, dynamic> _$TasteProfilePresetToJson(TasteProfilePreset instance) => <String, dynamic>{
