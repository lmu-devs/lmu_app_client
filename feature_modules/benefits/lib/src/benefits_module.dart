...
import 'presentation/routes/benefits_router.dart';
import 'presentation/state/benefits_state.dart';
...
class BenefitsModule extends AppModule
  ...
  void provideLocalDependencies() {
    ...
    final benefitsState = BenefitsState(getBenefitsUseCase, getCachedBenefitsUseCase);

    GetIt.I.registerSingleton<BenefitsRepositoryInterface>(benefitsRepository);
    GetIt.I.registerSingleton<BenefitsState>(benefitsState);
