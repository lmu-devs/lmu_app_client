...
part of 'clubs_details_page_driver.dart';
...
class $ClubsDetailsPageDriverProvider
  ...
  $ClubsDetailsPageDriverProvider({
    required ClubCategory? selectedCategory,
  }) : _selectedCategory = selectedCategory;

  @override
  ClubsDetailsPageDriver buildDriver() {
    return ClubsDetailsPageDriver(
      selectedCategory: _selectedCategory,
    );
  }

  @override
  ClubsDetailsPageDriver buildTestDriver() {
    return _$TestClubsDetailsPageDriver();
  }

  @override
  void updateDriverProvidedProperties(ClubsDetailsPageDriver driver) {
