...
extension $PeopleMainRouteExtension on PeopleMainRoute {
  static PeopleMainRoute _fromState(GoRouterState state) =>
...
extension $AllPeopleRouteExtension on AllPeopleRoute {
  static AllPeopleRoute _fromState(GoRouterState state) =>
